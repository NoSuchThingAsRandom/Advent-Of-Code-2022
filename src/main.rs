...
fn main() {
    ...
    //println!("Day 2 Part 1: {}", day02::part_1(false).unwrap());
    //println!("Day 2 Part 2: {}", day02::part_2(false).unwrap());
    //println!("Day 3 Part 1: {}", day03::part_1(false).unwrap());
    //println!("Day 3 Part 2: {}", day03::part_2(false).unwrap());
